...
# if the two strings are anagrams. The program should prompt for
...
#
# Constraints
# • Implement the program using a function called `anagram?`, which takes in two words as its arguments and returns true or false. Invoke this function from your main program.
